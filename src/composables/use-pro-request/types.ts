...
export interface UseProRequestOptions<Data, Params extends any[]>
  extends UseRequestOptions<Data, Params> {}

export type UseProRequestPlugin<Data, Params extends any[]> =
