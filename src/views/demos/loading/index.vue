...
function showDynamicFunctionalLoading() {
  ...
  dynamicFunctionalLoadingTimeout1 = setTimeout(() => {
    if (dynamicFunctionalLoading) {
      dynamicFunctionalLoading.description.value = $t(
        'pages.demos.loading.functionalDynamic.connectingServer'
      )
    }
  }, 1000)
  ...
  dynamicFunctionalLoadingTimeout2 = setTimeout(() => {
    if (dynamicFunctionalLoading) {
      dynamicFunctionalLoading.description.value = $t(
        'pages.demos.loading.functionalDynamic.fetchingData'
      )
    }
  }, 2000)
  ...
  dynamicFunctionalLoadingTimeout3 = setTimeout(() => {
    if (dynamicFunctionalLoading) {
      dynamicFunctionalLoading.description.value = $t(
        'pages.demos.loading.functionalDynamic.processingResult'
      )
    }
  }, 3000)
  ...
  dynamicFunctionalLoadingTimeout4 = setTimeout(() => {
    if (dynamicFunctionalLoading) {
      dynamicFunctionalLoading.description.value = $t(
        'pages.demos.loading.functionalDynamic.almostComplete'
      )
    }
  }, 4000)
...
<template>
  <n-flex size="large" vertical>
    <n-card :title="$t('pages.demos.loading.basicUsage.title')">
      <n-flex size="medium" vertical>
        <n-flex v-loading="basicLoading" size="small" vertical>
        ...
        <n-button type="primary" @click="toggleBasicLoading">
          {{
            basicLoading
              ? $t('pages.demos.loading.basicUsage.hideButton')
              : $t('pages.demos.loading.basicUsage.showButton')
          }}
        </n-button>
      </n-flex>
    </n-card>
    ...
    <n-card :title="$t('pages.demos.loading.fullscreen.title')">
      <n-flex size="medium" vertical>
        <n-flex v-loading.fullscreen="fullscreenLoading" size="small" vertical>
        ...
        <n-button type="info" @click="toggleFullscreenLoading">
          {{
            fullscreenLoading
              ? $t('pages.demos.loading.fullscreen.hideButton')
              : $t('pages.demos.loading.fullscreen.showButton')
          }}
        </n-button>
      </n-flex>
    </n-card>
    ...
    <n-card :title="$t('pages.demos.loading.lock.title')">
      <n-flex size="medium" vertical>
        <n-flex size="small" vertical>
          ...
          <div v-loading.lock="lockLoading" class="h-200px overflow-auto p-10px">
        ...
        <n-button type="warning" @click="toggleLockLoading">
          {{
            lockLoading
              ? $t('pages.demos.loading.lock.hideButton')
              : $t('pages.demos.loading.lock.showButton')
          }}
        </n-button>
      </n-flex>
    </n-card>
    ...
    <n-card :title="$t('pages.demos.loading.dynamic.title')">
      <n-flex size="medium" vertical>
        <n-flex v-loading="dynamicLoading" size="small" vertical>
        ...
        <n-button type="success" @click="toggleDynamicLoading">
    ...
    <n-card :title="$t('pages.demos.loading.functional.title')">
      <n-flex size="medium" vertical>
        ...
        <n-button type="error" @click="showFunctionalLoading">
          {{
            functionalLoading
              ? $t('pages.demos.loading.functional.hideButton')
              : $t('pages.demos.loading.functional.showButton')
          }}
        </n-button>
      </n-flex>
    </n-card>
    ...
    <n-card :title="$t('pages.demos.loading.functionalDynamic.title')">
      <n-flex size="medium" vertical>
        ...
        <n-button type="primary" @click="showDynamicFunctionalLoading">
          {{
            dynamicFunctionalLoading
              ? $t('pages.demos.loading.functionalDynamic.hideButton')
              : $t('pages.demos.loading.functionalDynamic.showButton')
          }}
        </n-button>
      </n-flex>
    </n-card>
