...
<template>
  <div class="size-full justify-center items-center">
    <n-card :title="$t('pages.demos.wangEditor.basicUsage')">
      <div class="grid-cols-responsive-1-3-3 gap-4 mb-4">
        ...
        <div>
          ...
          <n-select v-model:value="status" :options="statusOptions" clearable />
        </div>
        <div>
    ...
    <n-card :title="$t('pages.demos.wangEditor.usingProForm')" class="my-4">
      <pro-form :form="form">
        <pro-wang-editor
        ...
        <n-row :gutter="[0, 24]">
          <n-col :span="24">
            <n-button attr-type="submit" round type="primary">
    ...
    <n-card :title="$t('pages.demos.wangEditor.usingNForm')" class="my-4">
      <n-form ref="formRef" :model="model" :rules="rules">
        <n-form-item :label="$t('pages.demos.wangEditor.richText')" path="wangeditor">
